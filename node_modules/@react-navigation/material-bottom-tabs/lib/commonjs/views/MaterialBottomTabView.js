...
function MaterialBottomTabViewInner(_ref2) {
  ...
  const paperTheme = (0, _reactNativePaper.useTheme)();
  const buildLink = (0, _native.useLinkBuilder)();
  const t = // If the theme from React Navigation and Paper match, then user the customized theme
  // Otherwise fallback to the matching default theme from Paper
  dark === paperTheme.dark ? paperTheme : dark ? _reactNativePaper.DarkTheme : _reactNativePaper.DefaultTheme;
