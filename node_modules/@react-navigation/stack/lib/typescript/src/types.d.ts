...
declare type SceneOptionsDefaults = TransitionPreset & {
...
export declare type SceneProgress = {
    /**
...
export declare type StackDescriptor = Descriptor<StackNavigationOptions, StackNavigationProp<ParamListBase>, RouteProp<ParamListBase>>;
export declare type StackDescriptorMap = Record<string, StackDescriptor>;
