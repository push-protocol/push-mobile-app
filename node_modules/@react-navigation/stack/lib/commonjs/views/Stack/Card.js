...
class Card extends React.Component {
  constructor() {
    ...
    _defineProperty(this, "getInterpolatedStyle", (0, _memoize.default)((styleInterpolator, animation) => styleInterpolator(animation)));

    _defineProperty(this, "getCardAnimation", (0, _memoize.default)((interpolationIndex, current, next, layout, insetTop, insetRight, insetBottom, insetLeft) => ({
...
const getIsModalPresentation = cardStyleInterpolator => {
  return cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS || // Handle custom modal presentation interpolators as well
