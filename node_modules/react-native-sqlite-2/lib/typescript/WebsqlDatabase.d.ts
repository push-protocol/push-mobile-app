...
export interface WebsqlDatabaseCallback {
    (database: WebsqlDatabase): void;
}
...
export interface SQLTransaction {
    executeSql(sqlStatement: DOMString, args?: ObjectArray, callback?: SQLStatementCallback, errorCallback?: SQLStatementErrorCallback): void;
}
