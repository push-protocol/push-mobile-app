  ...
  return (
    <LinearGradient colors={['#EEF5FF', '#ECE9FA']} style={styles.container}>
      ...
      <View style={styles.options}>
        ...
        <TouchableOpacity
          style={[styles.iconContainer, styles.backgroundRed]}
          onPress={toggleVideo}>
          <Feather name={true ? 'video' : 'video-off'} style={styles.icon} />
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.iconContainer, styles.backgroundRed]}
          onPress={toggleAudio}>
          <Ionicons
            name={true ? 'mic-outline' : 'mic-off-outline'}
            style={styles.icon}
          />
        </TouchableOpacity>
        <TouchableOpacity
