  ...
  return (
    ...
    >
      ...
      <View style={styles.inner}>
        <View style={styles.header}>
          ...
          <View style={styles.blockchain}>
            {item.blockchain != null ? (
              item.blockchain == "ETH_TEST_ROPSTEN" ? (
                <Image
                  source={require("../../../../assets/ui/ethereum.png")}
                  style={{ width: 20, height: 20 }}
                />
              ) : item.blockchain == "POLYGON_TEST_MUMBAI" ? (
                <Image
                  source={require("../../../../assets/ui/polygon.png")}
                  style={{ width: 20, height: 20 }}
                />
              ) : null
            ) : null}
        ...
        <View
          style={{
            backgroundColor: props.spam ? "rgba(0,0,0,0.25)" : "#ffffff",
          }}
        >
          {loading == true ? (
